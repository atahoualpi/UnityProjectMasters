...
public class ModalDataScript_FilterBased : MonoBehaviour {
    ...
    public void IdentifyObject(Transform currObj, int hitPoint)
    {
        switch (currObj.tag)
        {
            ...
            case "cup":
                ...
                AudioManager_FilterBased.objectPerimeter = 0.236f * scaleAvg;
                SetCupData(hitPoint);
                break;
            case "cuttingboard":
                //myObj = ObjectName.CuttingBoard;
                AudioManager_FilterBased.objectPerimeter = 1.303f * scaleAvg;
                SetBoardData(hitPoint);
                break;
            case "jug":
                //myObj = ObjectName.Jug;
                AudioManager_FilterBased.objectPerimeter = 0.439f * scaleAvg;
                SetJugData(hitPoint);
                break;
            case "mortar":
                //myObj = ObjectName.Mortar;
                AudioManager_FilterBased.objectPerimeter = 0.345f * scaleAvg;
                SetMortarData(hitPoint);
                break;
            case "bowl":
                //myObj = ObjectName.PlasticBowl;
                AudioManager_FilterBased.objectPerimeter = 0.628f * scaleAvg;
                SetBowlData(hitPoint);
                break;
            case "plate":
                //myObj = ObjectName.Plate;
                AudioManager_FilterBased.objectPerimeter = 0.801f * scaleAvg;
                SetPlateData(hitPoint);
                break;
            case "rollingpin":
                //myObj = ObjectName.RollingPin;
                AudioManager_FilterBased.objectPerimeter = 0.22f * scaleAvg;
            ...
            case "wineglass":
                ...
                AudioManager_FilterBased.objectPerimeter = 0.251f * scaleAvg;
                SetGlassData(hitPoint);
                break;
            case "wok":
                //myObj = ObjectName.Wok;
                AudioManager_FilterBased.objectPerimeter = 0.471f * scaleAvg;
                SetWokData(hitPoint);
                break;
            default:
    ...
    void SetPlateOuter()
    {
        freq_modes = new float[10] { 1857.238770f, 4169.366455f, 2979.656982f, 1714.581299f, 4061.700439f, 5377.917480f, 2861.224365f, 823.645020f, 6345.911621f, 5084.527588f };
        ampl_modes = new float[10] { 1f, 0.205835f, 0.079758f, 0.254087f, 0.086239f, 0.019413f, 0.032756f, 0.091736f, 0.019353f, 0.090116f };
    }
    void SetPlateCenter()
    {
