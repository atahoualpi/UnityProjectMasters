...
[CustomEditor(typeof(cubeScript_FB))]
[CanEditMultipleObjects]
public class CubeManager_FB_Editor : Editor
{
    static void CreateFilterBasedAudioManager()
    {
        ...
        if (target != null)
        {
            target.AddComponent<cubeScript_FB>();
        }
    }

    cubeScript_FB scriptTarget;

    private void OnEnable()
    {
        scriptTarget = (cubeScript_FB)target;
    }
