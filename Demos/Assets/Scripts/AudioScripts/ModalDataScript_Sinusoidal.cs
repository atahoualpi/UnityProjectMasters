...
public class ModalDataScript_Sinusoidal : MonoBehaviour {
    ...
    public void IdentifyObject(Transform currObj, int hitPoint)
    {
        switch (currObj.tag)
        {
            case "cookingpot":
                //myObj = ObjectName.CookingPot;
                AudioManager_Sinusoidal.objectPerimeter = 0.675f * scaleAvg;
                SetPotData(hitPoint);
                break;
            case "cup":
                //myObj = ObjectName.Cup;
                AudioManager_Sinusoidal.objectPerimeter = 0.236f * scaleAvg;
                SetCupData(hitPoint);
                break;
            case "cuttingboard":
                //myObj = ObjectName.CuttingBoard;
                AudioManager_Sinusoidal.objectPerimeter = 1.303f * scaleAvg;
                SetBoardData(hitPoint);
                break;
            case "jug":
                //myObj = ObjectName.Jug;
                AudioManager_Sinusoidal.objectPerimeter = 0.439f * scaleAvg;
                SetJugData(hitPoint);
                break;
            case "mortar":
                //myObj = ObjectName.Mortar;
                AudioManager_Sinusoidal.objectPerimeter = 0.345f * scaleAvg;
                SetMortarData(hitPoint);
                break;
            case "bowl":
                //myObj = ObjectName.PlasticBowl;
                AudioManager_Sinusoidal.objectPerimeter = 0.628f * scaleAvg;
                SetBowlData(hitPoint);
                break;
            case "plate":
                //myObj = ObjectName.Plate;
                AudioManager_Sinusoidal.objectPerimeter = 0.801f * scaleAvg;
                SetPlateData(hitPoint);
                break;
            case "rollingpin":
                //myObj = ObjectName.RollingPin;
                AudioManager_Sinusoidal.objectPerimeter = 0.22f * scaleAvg;
                SetRollingData(hitPoint);
                break;
            case "winebottle":
                //myObj = ObjectName.WineBottle;
                AudioManager_Sinusoidal.objectPerimeter = 0.22f * scaleAvg;
                SetBottleData(hitPoint);
                break;
            case "wineglass":
                //myObj = ObjectName.WineGlass;
                AudioManager_Sinusoidal.objectPerimeter = 0.251f * scaleAvg;
                SetGlassData(hitPoint);
                break;
            case "wok":
                //myObj = ObjectName.Wok;
                AudioManager_Sinusoidal.objectPerimeter = 0.471f * scaleAvg;
                SetWokData(hitPoint);
                break;
            default:
                Debug.LogError("Check tags!");
    ...
    public void SetTheFreqs()
    {
        ...
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Freq1, freq_modes[0] * multiplier);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Freq2, freq_modes[1] * multiplier);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Freq3, freq_modes[2] * multiplier);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Freq4, freq_modes[3] * multiplier);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Freq5, freq_modes[4] * multiplier);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Freq6, freq_modes[5] * multiplier);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Freq7, freq_modes[6] * multiplier);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Freq8, freq_modes[7] * multiplier);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Freq9, freq_modes[8] * multiplier);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Freq10, freq_modes[9] * multiplier);
    }

    // sets amplitude values to the Heavy script
    public void SetTheAmpls()
    {
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Amp1, ampl_modes[0]);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Amp2, ampl_modes[1]);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Amp3, ampl_modes[2]);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Amp4, ampl_modes[3]);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Amp5, ampl_modes[4]);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Amp6, ampl_modes[5]);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Amp7, ampl_modes[6]);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Amp8, ampl_modes[7]);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Amp9, ampl_modes[8]);
        HeavyScript.SetFloatParameter(Hv_SinusRolling_AudioLib.Parameter.Amp10, ampl_modes[9]);
