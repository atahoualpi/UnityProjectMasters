...
public class ModalDataScript_Sinusoidal : MonoBehaviour {
    ...
    public void SetTheFreqs()
    {
        ...
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq1, freq_modes[0] * multiplier);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq2, freq_modes[1] * multiplier);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq3, freq_modes[2] * multiplier);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq4, freq_modes[3] * multiplier);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq5, freq_modes[4] * multiplier);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq6, freq_modes[5] * multiplier);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq7, freq_modes[6] * multiplier);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq8, freq_modes[7] * multiplier);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq9, freq_modes[8] * multiplier);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq10, freq_modes[9] * multiplier);
    }

    // sets amplitude values to the Heavy script
    public void SetTheAmpls()
    {
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Amp1, ampl_modes[0]);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Amp2, ampl_modes[1]);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Amp3, ampl_modes[2]);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Amp4, ampl_modes[3]);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Amp5, ampl_modes[4]);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Amp6, ampl_modes[5]);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Amp7, ampl_modes[6]);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Amp8, ampl_modes[7]);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Amp9, ampl_modes[8]);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Amp10, ampl_modes[9]);
