...
public class cubeScript : MonoBehaviour {
    ...
    public void SetTheFreqs()
    {
        ...
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq1, freq_modes[0] * multiplier * edge_mult);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq2, freq_modes[1] * multiplier * edge_mult);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq3, freq_modes[2] * multiplier * edge_mult);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq4, freq_modes[3] * multiplier * edge_mult);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq5, freq_modes[4] * multiplier * edge_mult);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq6, freq_modes[5] * multiplier * edge_mult);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq7, freq_modes[6] * multiplier * edge_mult);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq8, freq_modes[7] * multiplier * edge_mult);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq9, freq_modes[8] * multiplier * edge_mult);
        HeavyScript.SetFloatParameter(Hv_Sinusoidal_AudioLib.Parameter.Freq10, freq_modes[9] * multiplier * edge_mult);
    }
